            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden" style={{ backgroundColor: '#FFFFFF' }}>
                  {project.iconType === 'image' ? <img src={project.icon} alt={project.title} className="w-12 h-12 object-contain" loading="lazy" decoding="async" /> : <project.icon size={22} className="text-white" />}
                </div>
